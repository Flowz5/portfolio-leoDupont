document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        fr: {
            ...
            term_github: "Voir le code source du portfolio",
            veille_title: "Veille Technologique", veille_sub: "Actualités et tendances en développement et IA.",
            read_article: "Lire l'article", news_loading: "<i class='fas fa-spinner fa-spin'></i> Chargement des actualités...", veille_more: "Découvrir mon projet complet de Veille",
        ...
        en: {
            ...
            term_github: "View portfolio source code",
            veille_title: "Tech Watch", veille_sub: "News and trends in software development and AI.",
            read_article: "Read Article", news_loading: "<i class='fas fa-spinner fa-spin'></i> Loading news...", veille_more: "Discover my full Tech Watch project",
