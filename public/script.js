document.addEventListener("DOMContentLoaded", () => {
    ...
    const terminalLogic = {
        'help': "Commandes disponibles :<br>- <strong>ctrl+K</strong> : Ouvrir la palette de commandes<br>- <strong>whoami</strong> : En savoir plus sur moi<br>- <strong>skills</strong> : Afficher mes compétences clés<br>- <strong>contact</strong> : Mes informations de contact<br>- <strong>clear</strong> : Nettoyer le terminal",
